...
public class GDLLoaderTemporalTest {
    ...
    public void periodLiteralTest(){
        ...
        assertPredicateEquals(loader.getPredicates().get(),
                new And(
                new Comparison(
                        new MaxTimePoint(new TimeSelector("a", TimeSelector.TimeField.TX_FROM),
                                tl1),
                        LT,
                        new MinTimePoint(new TimeSelector("a", TimeSelector.TimeField.TX_TO),
                                tl2)
                ),
    ...
    public void asOfTest(){
        ...
        expected = new And(
          new Comparison(
            new TimeSelector("e", TimeSelector.TimeField.VAL_FROM),
            LTE,
            new TimeSelector("a", TimeSelector.TimeField.TX_FROM)),
        new Comparison(
          new TimeSelector("a", TimeSelector.TimeField.TX_FROM),
    ...
    public void globalPredicateTest(){
        ...
        TimeSelector eValFrom = new TimeSelector("e", TimeSelector.TimeField.VAL_FROM);
    ...
    public void containsTest(){
        ...
        Predicate expected = new And(
                new Comparison(new TimeSelector("a", TimeSelector.TimeField.TX_FROM), LTE, new TimeSelector("b", TimeSelector.TimeField.VAL_FROM)),
                new Comparison(new TimeSelector("a", TimeSelector.TimeField.TX_TO), GTE, new TimeSelector("b", TimeSelector.TimeField.VAL_TO))
        );
        assertTrue(loader.getPredicates().isPresent());
        assertPredicateEquals(expected, loader.getPredicates().get());
    }
    ...
    public void comparisonTest(){
        ...
        Predicate expected = new And(
                new Comparison(new TimeSelector("a", TimeSelector.TimeField.TX_FROM), GT,
                        new TimeSelector("b", TimeSelector.TimeField.VAL_FROM)),
    ...
    public void immediatelyPrecedesTest(){
        ...
        Predicate expected = new Comparison(
                new TimeSelector("a", TimeSelector.TimeField.TX_TO), EQ, new TimeSelector("e",
          TimeSelector.TimeField.VAL_FROM)
        );
        assertTrue(loader.getPredicates().isPresent());
        assertPredicateEquals(loader.getPredicates().get(), expected);
    }
    ...
    public void immediatelySucceedsTest(){
        ...
        Predicate expected = new Comparison(
                new TimeSelector("a", TimeSelector.TimeField.TX_FROM), EQ, new TimeSelector("e", TimeSelector.TimeField.VAL_TO)
        );
        assertTrue(loader.getPredicates().isPresent());
        assertPredicateEquals(loader.getPredicates().get(), expected);
    }
    ...
    public void equalsTest(){
        ...
        Predicate expected = new And(
                new Comparison(new TimeSelector("a", TimeSelector.TimeField.TX_FROM), EQ, new TimeSelector(
                  "e", TimeSelector.TimeField.VAL_FROM)),
                new Comparison(new TimeSelector("a", TimeSelector.TimeField.TX_TO), EQ, new TimeSelector("e", TimeSelector.TimeField.VAL_TO))
        );
        assertTrue(loader.getPredicates().isPresent());
        assertPredicateEquals(loader.getPredicates().get(), expected);
    }
    ...
    public void minMaxTest(){
        TimeSelector aTxFrom = new TimeSelector("a", TimeSelector.TimeField.TX_FROM);
        TimeSelector bTxFrom = new TimeSelector("b", TimeSelector.TimeField.TX_FROM);
        TimeSelector eTxFrom = new TimeSelector("e", TimeSelector.TimeField.TX_FROM);
        TimeSelector aValTo = new TimeSelector("a", TimeSelector.TimeField.VAL_TO);
        TimeSelector bValTo = new TimeSelector("b", TimeSelector.TimeField.VAL_TO);
        TimeSelector eValTo = new TimeSelector("e", TimeSelector.TimeField.VAL_TO);
        ...
        expected = new And(
                ...
                new Comparison(aTxFrom, GTE, new TimeSelector("b", TimeSelector.TimeField.TX_TO))
        );
        assertTrue(loader.getPredicates().isPresent());
        assertPredicateEquals(loader.getPredicates().get(), expected);
    }
    ...
    private void lengthComparisonTest(String operator, Comparator comparator){
        ...
        TimeSelector aTxFrom = new TimeSelector("a", TimeSelector.TimeField.TX_FROM);
        TimeSelector bTxFrom = new TimeSelector("b", TimeSelector.TimeField.TX_FROM);
        TimeSelector eTxTo = new TimeSelector("e", TimeSelector.TimeField.TX_TO);
        TimeSelector aTxTo = new TimeSelector("a", TimeSelector.TimeField.TX_TO);
        TimeSelector bTxTo = new TimeSelector("b", TimeSelector.TimeField.TX_TO);
