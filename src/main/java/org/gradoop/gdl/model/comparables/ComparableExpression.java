...
public interface ComparableExpression extends Serializable{
   ...
   * @return comparable with global selector replaced by their local variable equivalent expressions.
   * If comparable is not a global time selector, identity function.
   */
